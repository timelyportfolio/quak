 ...
 * @example
 * ```sh
 * $ deno run -A scripts/build_htmlwidget.ts
 * $ deno run -A scripts/build._htmlwidget.ts --watch
 * $ deno run -A scripts/build_build_htmlwidget.ts --bundle
 * ```
 *
...
let options: esbuild.BuildOptions = {
	...
	entryPoints: ["./lib/htmlwidget.js"],
	outfile: "./src/quak/quak_htmlwidget.js",
	bundle: true,
	format: "iife",
	globalName: "quak",
	sourcemap: "inline",
